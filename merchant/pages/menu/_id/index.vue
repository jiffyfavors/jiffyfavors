<template>
    <v-card flat id="create" class="overflow-hidden">
                            ...
                            <v-card-text>
                                <v-data-table v-model="selected" :headers="headers" :items="getFood(categories[0])" item-key="id" show-select class="elevation-1">
                                    <template v-slot:item.actions="{ item }">
                                        ...
                                        <v-icon @click.stop="deleteFoodItem(item)" color="red">mdi-delete</v-icon>
                                    </template>
                                </v-data-table>
                            </v-card-text>
                        </v-card>
        ...
        <v-btn v-model="fab" class="fabicon" @click.stop="actionSheet = true" color="blue darken-2" bottom right dark fab>
        ...
        <v-bottom-sheet inset v-model="actionSheet">
            <v-list single-line dense>
                ...
                <v-list-item-group>
                    <v-list-item @click.stop="editItem(current_cat)">
                        <v-list-item-icon>
                ...
                <v-list-item-group>
                    <v-list-item @click.stop="deleteItem(current_cat)">
                        <v-list-item-icon>
                            <v-icon small color="blue"> mdi-delete </v-icon>
                        </v-list-item-icon>
                        <v-list-item-content>
                ...
                <v-list-item-group>
                    <v-list-item @click.stop="fooddialog =true">
                        <v-list-item-icon>
                            <v-icon small color="blue"> mdi-food </v-icon>
                        </v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>New Food Item</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-list-item-group>
            </v-list>
